...
class TestDB(unittest.TestCase):
    ...
    def test_getAllFutureSimple(self):
        """Тест на отримання всіх даних з таблиці FutureSimple"""
    ...
    def test_getAllPresentSimple(self):
        """Тест на отримання всіх даних з таблиці PresentSimple"""
    ...
    def test_getAllPastSimple(self):
        """Тест на отримання всіх даних з таблиці PastSimple"""
    ...
    def test_insertUser(self):
        """Тест вставки користувача в базу даних"""
        resp = insertUser(self.db, self.user)
        self.assertEqual(resp, 'ok')

    def test_deleteUser(self):
        """Тест видалення користувача в базу даних"""
